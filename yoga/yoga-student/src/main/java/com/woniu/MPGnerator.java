...
public class MPGnerator {
	public static void main(String[] args) {
		...
		config.setAuthor("tx") //作者
				.setOutputDir("D:\\perproty\\yoga-prop\\yoga\\yoga-student\\src\\main\\java")  //生成路径
		...
		dsConfig.setDbType(DbType.MYSQL)
				.setUrl("jdbc:mysql://localhost:3306/yoga")
		...
		stConfig.setCapitalMode(true) // 全局大写命名
				...
				.setInclude("t_student").setEntityLombokModel(true);//生成的表,参数为数组
		//4.包名策略
